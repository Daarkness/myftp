...
class nbNetBase:
    ...
    def read(self, fd):
        ...
        try:
            ...
            res_read = str(one_read, encoding = "utf8")
            if len(one_read) == 0:
                raise socket.error
    ...
    def write(self, fd):
        ...
        if sock_state.popen_pipe:
            ...
            try:
                ...
                print(type(sock_state.buff_write[last_have_send:]))
                row_data = bytes(sock_state.buff_write[last_have_send:],encoding = "utf8")
                print(sock_state.buff_write[last_have_send:])
